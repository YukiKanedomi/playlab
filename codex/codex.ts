...
// ── 開発の歩み ──
{
  ...
  const events: [string, string][] = [
    ...
    ['2026-07-01', '<b>No.05「うって、よけて。」</b>。Kenney(CC0)のフリー素材で“売り物”クオリティのシューター。'],
    ['2026-07-01', '<b>No.06「はしって、よけて。」</b>。three.js＋Kenney(CC0)の3Dで初の3Dドライバー。'],
    ['2026-07-02', '<b>No.07『霧雨館の一夜』</b>。脚本・トリック・証言の矛盾網までAIが書き下ろす、初のコンテンツ勝負（推理ADV）。'],
    ['2026-07-02', '<b>No.08『墨戯絵巻』</b>。筆の形を幾何で読むジェスチャー判定×墨の経済×鳥獣戯画ふう筆線の筆捌きTD。'],
    ['2026-07-02', '<b>墨戯絵巻 v2</b>。水墨画の「濃淡」（山水・にじみ・かすれ・飛沫）＋巻の合間の「画技」ドラフト。設計と実装をAI二段構え（Fable 5設計×Sonnet実装）で作る体制も初導入。'],
    ['2026-07-02', '<b>No.09『流灯』</b>。Stable Fluids を自前実装した初のシェーダー作品。触れられるのは水だけ——流れで墨を導き、赤と青を混ぜて紫を灯す。'],
    ['2026-07-02', '<b>流灯 v2</b>。雫つぼ（有限の墨）と月の評価で「張り」を、水脈の粒と水面反射と重なる和音で「洗練」を。白灯籠と月光の帯の十二夜構成に。'],
    ['2026-07-03', '<b>No.10『ばけ札』</b>。花札×Balatro型ローグライト。名作の設計原則を仕様書に埋め込み、アートは3案から選ぶ「儀式」で大正モダン×計器の「硝子行灯」に。'],
    ['2026-07-03', '<b>ばけ札 v2</b>。実機の声「役が分からない・絵が厳しい」に全面対応。選んだ瞬間に役と文が見えるライブプレビュー＋伝統柄の花札絵（CC BY-SA）へ。教訓：読み取り前提の大量アセットはコード描画では品質バーに届かない。'],
    ['2026-07-11', '<b>No.11『紋切』</b>。江戸の紙遊び・紋切り型のデジタル化。折られた紙をラスタで持ち、切線→連結成分分解→「本体以外は落ちる」という切り絵の物理をそのまま実装。ひらく瞬間の万華鏡合成が主役。'],
  ]
